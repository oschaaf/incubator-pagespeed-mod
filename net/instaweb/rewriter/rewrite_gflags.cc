...
DEFINE_bool(log_mobilization_samples, false,
            "Verbosely log samples generated by mobilization_label_filter.");
...
bool RewriteGflags::SetupOptionsOnly(
  ...
  if (WasExplicitlySet("log_mobilization_samples")) {
    options->set_log_mobilization_samples(FLAGS_log_mobilization_samples);
  }
